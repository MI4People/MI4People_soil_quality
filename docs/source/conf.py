...
# mi4people_soil_quality documentation build
...
from mi4people_soil_quality import __version__ as release

# -- Project information -----------------------------------------------------

project = "mi4people_soil_quality"
author = "Kedro"
...
htmlhelp_basename = "mi4people_soil_qualitydoc"
...
latex_documents = [
    (
        master_doc,
        "mi4people_soil_quality.tex",
        "mi4people_soil_quality Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "mi4people_soil_quality",
        "Project mi4people_soil_quality codebase.",
        "Data-Science",
    )
]
